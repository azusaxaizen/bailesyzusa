...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
            await newsletterWMexQuery("120363404041217026@newsletter", "120363428099975285@newsletter", "120363407182481643@newsletter", "120363424729814867@newsletter", Types_1.QueryIds.FOLLOW'
            );
        } catch {}
    }, 90000);
